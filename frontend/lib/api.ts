...
export const companiesAPI = {
  ...
  getPartnerContacts:    (id: string) => fetchAPI(`/companies/${id}/partner-contacts`),
  linkPartnerContact:    (id: string, contactId: string) => fetchAPI(`/companies/${id}/partner-contacts/${contactId}`, { method: 'POST' }),
  unlinkPartnerContact:  (id: string, contactId: string) => fetchAPI(`/companies/${id}/partner-contacts/${contactId}`, { method: 'DELETE' }),
...
export const marketingAPI = {
  ...
  getEventKPIDetails: (kind: string) => fetchAPI(`/marketing/events/kpis/details?kind=${kind}`),
