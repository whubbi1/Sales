...
function TPRMContent() {
  const { level } = useGRCPerm('tprm')
  ...
  if (level === 'none') return (
    <div style={{ padding: '48px', textAlign: 'center', color: '#94A3B8' }}>
      ...
      <p style={{ fontSize: '13px' }}>You don't have permission to access TPRM. Ask HR to grant it via WHUBBI Permissions.</p>
    </div>
  )
    ...
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 'calc(100vh - 40px)' }}>
      <div style={{ textAlign: 'center', padding: '48px' }}>
        ...
        <p style={{ fontSize: '14px', color: '#45B6E4', maxWidth: '420px', margin: '0 auto', lineHeight: '1.7' }}>
          Third-Party Risk Management is currently being developed. It will allow you to track and assess the risk posed by WCOMPLY's vendors and suppliers.
        </p>
      </div>
    </div>
  )
...
export default function TPRMPage() {
  return <GRCLayout><TPRMContent /></GRCLayout>
}
