...
export default function HomePage() {
  ...
  useEffect(()=>{
    fetch('https://api.whubbi.wcomply.com/health',{signal:AbortSignal.timeout(5000)})
    ...
    <div style={{minHeight:'100vh',background:'#F5F7FA',fontFamily:'Montserrat, sans-serif'}}>
      <div style={{background:'#156082',padding:'0 40px',display:'flex',alignItems:'center',justifyContent:'space-between',height:'64px'}}>
        ...
        <div style={{display:'flex',alignItems:'center',gap:'8px'}}>
          ...
          <span style={{color:'rgba(255,255,255,0.6)',fontSize:'11px'}}>{backendStatus==='up'?'All systems operational':backendStatus==='down'?'Backend unavailable':'Checking...'}</span>
        </div>
      </div>
