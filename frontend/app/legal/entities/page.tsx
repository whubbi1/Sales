...
function CodeBadge({ value }: { value: string }) {
  return (
    <span title="Code is set at creation and cannot be changed afterward" style={{
      ...
      background: '#EFF6FF', border: '1.5px solid transparent', borderRadius: '10px',
      padding: '2px 8px', display: 'inline-block', width: '64px', boxSizing: 'border-box' as const,
