...
export default function LegalEntitiesPage() {
  ...
  const createEntity = async () => {
    ...
    const r = await fetch(`${API}/legal/entities`, {
      ...
      body: JSON.stringify({ legal_name: newName.trim(), country: newCountry, created_by: userEmail }),
    })
      ...
      <div style={{ padding: '28px 32px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          {entities.map(entity => {
            ...
            return (
              <div key={entity.id} style={{ background: 'white', borderRadius: '12px', border: '1px solid #EDF2F7', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', overflow: 'hidden' }}>
