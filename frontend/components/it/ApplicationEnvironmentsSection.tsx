...
export function ApplicationEnvironmentsSection({ application, canEdit }: any) {
  ...
  return (
    <div style={{ background: 'white', borderRadius: '12px', border: '1px solid #EDF2F7', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', padding: '20px 24px', marginBottom: '16px' }}>
      <h2 style={{ fontSize: '15px', fontWeight: '800', color: '#156082', margin: '0 0 14px' }}>🌍 Environments</h2>
