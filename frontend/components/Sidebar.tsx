...
const navItems = [
  ...
  },
  {
    ...
    icon: <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
  },
]
...
export function Sidebar() {
  ...
  return (
    <aside style={{
      width: '220px', minHeight: '100vh', background: '#144766',
        ...
        {navItems.map(item => {
          ...
          return (
            <Link key={item.href} href={item.href} style={{
              ...
              padding: '8px 11px', borderRadius: '6px', marginBottom: '1px',
