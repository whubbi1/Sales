...
const navItems = [
  ...
  { href: '/partners', label: 'Partners', indent: true, icon: <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M16 3.13a4 4 0 0 1 3.87 3.72"/><path d="M22 21v-2a4 4 0 0 0-2.24-3.6"/><circle cx="18" cy="7" r="3"/></svg> },
  ...
  { href: '/rfp', label: 'RFP', icon: <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="13" x2="15" y2="13"/><line x1="9" y1="17" x2="13" y2="17"/></svg> },
    ...
    <aside style={{ width: '220px', minHeight: '100vh', background: '#156082', position: 'fixed', left: 0, top: 0, zIndex: 100, display: 'flex', flexDirection: 'column', borderRight: '1px solid rgba(255,255,255,0.06)' }}>
      ...
      <nav style={{ flex: 1, padding: '4px 8px' }}>
        {navItems.map(item => {
          ...
          return (
            <Link key={item.href} href={item.href} style={{ display: 'flex', alignItems: 'center', gap: '9px', padding: '8px 11px', paddingLeft: item.indent ? '26px' : '11px', borderRadius: '6px', marginBottom: '1px', color: active ? 'white' : 'rgba(255,255,255,0.55)', background: active ? 'rgba(255,255,255,0.12)' : 'transparent', textDecoration: 'none', fontSize: item.indent ? '11.5px' : '12.5px', fontWeight: active ? '600' : '400', transition: 'all 0.12s', letterSpacing: '0.01em' }}>
